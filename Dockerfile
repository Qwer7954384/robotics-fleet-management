# ============================================
# Multi-stage Dockerfile for Robotics Fleet Management Service
...
LABEL org.opencontainers.image.title="Robotics Fleet Management Service" \
      org.opencontainers.image.description="AMR and AGV orchestration with path planning and collision avoidance" \
      org.opencontainers.image.version="${APP_VERSION}" \
      org.opencontainers.image.vendor="Paklog" \
      org.opencontainers.image.authors="Paklog Engineering Team" \
      org.opencontainers.image.source="https://github.com/paklog/robotics-fleet-management" \
